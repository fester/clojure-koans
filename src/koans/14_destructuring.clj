...
(meditations
  ...
  (= "Rich Hickey aka The Clojurer aka Go Time aka Macro Killah"
     (let [[first-name last-name & aliases]
       ...
       (reduce #(str %1 " aka " %2) (cons (str first-name " " last-name) aliases))))
  ...
  (= "Test Testerson, 123 Test Lane, Testerville, TX"
     ((fn [[fn ln] {street-address :street-address, city :city, state :state}]
        (str fn " " ln ", " street-address ", " city ", " state))
